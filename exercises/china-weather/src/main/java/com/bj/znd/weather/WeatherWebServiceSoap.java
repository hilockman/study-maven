...
public interface WeatherWebServiceSoap {
     ...
     * @return
     *     returns com.bj.znd.weather.ArrayOfString
     */
    @WebMethod(action = "http://WebXml.com.cn/getSupportCity")
    @WebResult(name = "getSupportCityResult", targetNamespace = "http://WebXml.com.cn/")
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetSupportCityResponse")
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetSupportProvinceResponse")
     ...
     * 
     * @return
     *     returns com.bj.znd.weather.GetSupportDataSetResponse.GetSupportDataSetResult
     */
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetSupportDataSetResponse")
    public com.bj.znd.weather.GetSupportDataSetResponse.GetSupportDataSetResult getSupportDataSet();
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetWeatherbyCityNameResponse")
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.bj.znd.weather.GetWeatherbyCityNameProResponse")
